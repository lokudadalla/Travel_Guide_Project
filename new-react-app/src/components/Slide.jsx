...
import TravelLankaApp from "./AppComponent.jsx";
            ...
            <Carousel controls={true} indicators={false} interval={4000} pause="hover">
                <Carousel.Item>
                    <img
                        ...
                        alt="First slide"
                    />
                    <Carousel.Caption style={{ top: "19%", transform: "translateY(-50%)", bottom: "unset" }}>
                ...
                <Carousel.Item>
                    <img
                        ...
                        alt="Second slide"
                    />
                    <Carousel.Caption style={{ top: "50%", transform: "translateY(-50%)", bottom: "unset", right: "15%" }}>
                        <h1 className="d-block w-full text-black 5xl font-bold">Cultural Behaviour</h1>
